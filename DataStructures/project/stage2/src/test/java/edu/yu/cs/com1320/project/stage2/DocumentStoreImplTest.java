...
public class DocumentStoreImplTest {
  ...
  void testUndo() {
    ...
    System.out.println(("Key1: " + (documentStore.getDocument(uriArray[1]) != null ? (documentStore.getDocument(uriArray[1]).getKey() + " | Text: " + documentStore.getDocument(uriArray[1]).getDocumentTxt()) : null)));
    System.out.println(("Key6: " + (documentStore.getDocument(uriArray[6]) != null ? (documentStore.getDocument(uriArray[6]).getKey() + " | Text: " + documentStore.getDocument(uriArray[6]).getDocumentTxt()) : null)));
    ...
    System.out.println("tested equals passed");

    System.out.println(("Key1: " + (documentStore.getDocument(uriArray[1]) != null ? (documentStore.getDocument(uriArray[1]).getKey() + " | Text: " + documentStore.getDocument(uriArray[1]).getDocumentTxt()) : null)));
    System.out.println(("Key6: " + (documentStore.getDocument(uriArray[6]) != null ? (documentStore.getDocument(uriArray[6]).getKey() + " | Text: " + documentStore.getDocument(uriArray[6]).getDocumentTxt()) : null)));

    System.out.println("second undo (only uriArray[1])");
    documentStore.undo(uriArray[1]);//making uriArray[6] have value
